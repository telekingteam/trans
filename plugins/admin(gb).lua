...
if is_admin(msg) then
	 if matches[1] == 'reload' then
		...
		local out8 = '*80%*'
		local out9 = '*90%*'
		local out10 = '*Bot Reloaded!*'
		
		api.sendReply(msg, out, true)
		api.sendReply(msg, out1, true)
		api.sendReply(msg, out2, true)
		api.sendReply(msg, out3, true)
		api.sendReply(msg, out4, true)
		api.sendReply(msg, out5, true)
		api.sendReply(msg, out6, true)
		api.sendReply(msg, out7, true)
		api.sendReply(msg, out8, true)
		api.sendReply(msg, out9, true)
		api.sendReply(msg, out10, true)
	end
	--------------------------------------
